...
End If
   ...
   If tool.Caption = "Exportar" Then
        ...
        If ModVariables.xEstadoComprobante <> "CANCELA" Then
            Dialogo.FileName = "" 'para que limpie el nombre, sino queda el �ltimo usado
...
Exit Sub
PROCERROR:
    If Err.Number = cdlCancel Then 'se presion� CANCELAR
        Exit Sub
    Else
        MsgBox "Ha ocurrido un error en la generaci�n de la exportaci�n", vbExclamation, "Atenci�n"
    End If
End Sub
...
With RsRead
    ...
    Else
        .Close
        MsgBox "No se encontr� el N� de Remito", vbInformation, "Atenci�n"
        Unload Me
    End If
End With
